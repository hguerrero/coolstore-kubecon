...
INSERT INTO INVENTORY (id, itemId, link, location, quantity) values (nextval('hibernate_sequence'), '444439', 'http://maps.google.com/?q=Raleigh', 'Raleigh', 350);
INSERT INTO INVENTORY (id, itemId, link, location, quantity) values (nextval('hibernate_sequence'), '444450', 'http://maps.google.com/?q=Raleigh', 'Raleigh', 879);
INSERT INTO INVENTORY (id, itemId, link, location, quantity) values (nextval('hibernate_sequence'), '444454', 'http://maps.google.com/?q=Raleigh', 'Raleigh', 540);
INSERT INTO INVENTORY (id, itemId, link, location, quantity) values (nextval('hibernate_sequence'), '444460', 'http://maps.google.com/?q=Raleigh', 'Raleigh', 920);
